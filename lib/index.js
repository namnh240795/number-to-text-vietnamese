...
const getThousand = (number) => {
  ...
  if (beforeLength === 1) {
    return `${base[before_number]} nghìn ${getHundred(after_number)}`;
  }

  if (beforeLength === 2) {
    return `${getTen(before_number)} nghìn ${getHundred(after_number)}`;
  }

  return `${getHundred(before_number)} nghìn ${getHundred(after_number)}`;
}
...
const getMillion = (number) => {
  ...
  const beforeLength = `${before_number}`.length;
  if (beforeLength === 1) {
    return `${base[before_number]} triệu ${getThousand(after_number)}`;
  }

  if (beforeLength === 2) {
    return `${getTen(before_number)} triệu ${getThousand(after_number)}`;
  }

  return `${getHundred(before_number)} triệu ${getThousand(after_number)}`;
};
...
const getBillion = (number) => {
  ...
  const beforeLength = `${before_number}`.length;
  if (beforeLength === 1) {
    return `${base[before_number]} tỷ ${getMillion(after_number)}`;
  }

  if (beforeLength === 2) {
    return `${getTen(before_number)} tỷ ${getMillion(after_number)}`;
  }

  if (beforeLength === 3) {
    return `${getHundred(before_number)} tỷ ${getMillion(after_number)}`;
  }

  if (beforeLength > 3 && beforeLength <= 6) {
    return `${getThousand(before_number)} tỷ ${getMillion(after_number)}`;
  }

  if (beforeLength > 6 && beforeLength <= 9) {
    return `${getMillion(before_number)} tỷ ${getMillion(after_number)}`;
  }

  if (beforeLength > 9) {
    return `${getBillion(before_number)} tỷ ${getMillion(after_number)}`;
  }
};
